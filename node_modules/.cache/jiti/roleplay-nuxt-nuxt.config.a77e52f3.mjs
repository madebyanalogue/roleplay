...
const _filename = (0, _url.fileURLToPath)("file:///Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/nuxt.config.ts");
const _dirname = (0, _path.dirname)(_filename);var _default = exports.default =
...
defineNuxtConfig({
  ...
  vite: {
    ...
    resolve: {
      alias: {
        'react-compiler-runtime': (0, _path.join)(_dirname, 'node_modules/react-compiler-runtime/dist/index.js'),
        '@sanity/visual-editing': (0, _path.join)(_dirname, 'stubs/sanity-visual-editing-stub.js')
      }
    },
    plugins: [
    {
      ...
      resolveId(id) {
        if (id.includes('react-compiler-runtime')) {
          return (0, _path.join)(_dirname, 'node_modules/react-compiler-runtime/dist/index.js');
        }
        if (id.includes('@sanity/visual-editing') && !id.includes('stub')) {
          return (0, _path.join)(_dirname, 'stubs/sanity-visual-editing-stub.js');
        }
      }
    }]
