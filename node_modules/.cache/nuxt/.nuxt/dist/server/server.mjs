import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, resolveComponent, computed, toValue, onServerPrefetch, ref, nextTick, unref, mergeProps, useSSRContext, withCtx, createVNode, toDisplayString, createTextVNode, Suspense, Fragment, watch, useAttrs, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/defu/dist/defu.mjs";
import { withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, parseURL, encodeParam, encodePath } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/ufo/dist/index.mjs";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderStyle, ssrRenderSlot, ssrRenderTeleport, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { debounce } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/perfect-debounce/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/joshwatts/Downloads/_NUXT/roleplay/roleplay-nuxt/node_modules/@unhead/vue/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-BnKkE6b_.js")
  },
  {
    name: "work-slug",
    path: "/work/:slug()",
    component: () => import("./_nuxt/_slug_-67eAeyKg.js")
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import("./_nuxt/index-C3ygZ0LA.js")
  },
  {
    name: "portfolio-slug",
    path: "/portfolio/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-4zFillY-.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CgUFWK07.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-YTkvgPVn.js"));
