...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-DhPXTuGA.js")
  },
  {
    name: "work-slug",
    path: "/work/:slug()",
    component: () => import("./_nuxt/_slug_-BWo5taEB.js")
  },
  {
    name: "portfolio",
    path: "/portfolio",
