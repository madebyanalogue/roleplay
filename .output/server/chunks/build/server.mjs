...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./_...slug_-BnKkE6b_.mjs')
  },
  {
    name: "work-slug",
    path: "/work/:slug()",
    component: () => import('./_slug_-67eAeyKg.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-c7833780><div class="header-bar header--styling" data-v-c7833780><div class="header-logo" data-v-c7833780>`);
      ...
      _push(`</div><nav class="header-nav" aria-label="Main" data-v-c7833780><!--[-->`);
      ssrRenderList(unref(headerMenuItems), (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="header-link-text" data-v-c7833780${_scopeId}>${ssrInterpolate(item.text)}</span>`);
            } else {
              return [
      ...
      if (unref(showContactButton) && unref(contactMounted)) {
        _push(`<div class="header-contact show-sm" data-v-c7833780>`);
        if (unref(contactButtonUrl)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div data-v-c7833780${_scopeId}>${ssrInterpolate(unref(navigationContact).buttonTitle)}</div>`);
              } else {
                return [
          ...
          _push(`<!--[--><button type="button" class="${ssrRenderClass([{ "header-contact-toggle-open": unref(contactOpen) }, "header-contact-toggle header--styling"])}"${ssrRenderAttr("aria-expanded", unref(contactOpen))} aria-haspopup="true" data-v-c7833780><div data-v-c7833780>${ssrInterpolate(unref(navigationContact).buttonTitle)}</div></button><div class="header-contact-panel white-text rounded-medium" role="region"${ssrRenderAttr("aria-label", unref(navigationContact).buttonTitle)} style="${ssrRenderStyle(unref(contactOpen) ? null : { display: "none" })}" data-v-c7833780><!--[-->`);
          ssrRenderList(unref(navigationContact).contacts, (row) => {
            _push(`<div class="header-contact-item pad-20" data-v-c7833780><div class="header-contact-item-title subtitle subtitle--circle white-dot" data-v-c7833780>${ssrInterpolate(row.title)}</div>`);
            if (unref(contactLinkUsesNative)(unref(getContactLinkUrl)(row))) {
              _push(`<a${ssrRenderAttr("href", unref(getContactLinkUrl)(row))}${ssrRenderAttr("target", unref(isExternalHttp)(unref(getContactLinkUrl)(row)) ? "_blank" : void 0)}${ssrRenderAttr("rel", unref(isExternalHttp)(unref(getContactLinkUrl)(row)) ? "noopener" : void 0)} class="header-contact-link" data-v-c7833780>${ssrInterpolate(row.linkText)}</a>`);
            } else {
              _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`<div class="${ssrRenderClass([{ "header-mobile--open": unref(mobileMenuOpen) }, "header-mobile header--styling"])}" data-v-c7833780><button type="button" class="header-menu-toggle"${ssrRenderAttr("aria-expanded", unref(mobileMenuOpen))} aria-controls="header-mobile-nav" data-v-c7833780>${ssrInterpolate(unref(mobileMenuOpen) ? "Close" : "Menu")}</button><div id="header-mobile-nav" class="header-mobile-panel header-mobile-panel--fullscreen" role="navigation" aria-label="Main" data-lenis-prevent style="${ssrRenderStyle(unref(mobileMenuOpen) ? null : { display: "none" })}" data-v-c7833780><div class="header-mobile-panel-main" data-v-c7833780><!--[-->`);
      ...
      if (unref(showMobileMenuSocialLinks)) {
        _push(`<div class="header-mobile-social" data-v-c7833780>`);
        if (unref(mobileMenuSocialLinksTitle).trim()) {
          _push(`<div class="header-mobile-social-title subtitle subtitle--circle orange-dot" data-v-c7833780>${ssrInterpolate(unref(mobileMenuSocialLinksTitle))}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="header-mobile-social-links underline-links" data-v-c7833780><!--[-->`);
        ssrRenderList(unref(mobileMenuSocialLinks), (row) => {
          _push(`<!--[-->`);
          if (unref(contactLinkUsesNative)(row.url)) {
            _push(`<a${ssrRenderAttr("href", row.url)}${ssrRenderAttr("target", unref(isExternalHttp)(row.url) ? "_blank" : void 0)}${ssrRenderAttr("rel", unref(isExternalHttp)(row.url) ? "noopener" : void 0)} class="header-mobile-social-link" data-v-c7833780>${ssrInterpolate(row.title)}</a>`);
          } else {
            _push(ssrRenderComponent(_component_NuxtLink, {
              to: row.url,
      ...
      if (unref(headerType) === "fixed") {
        _push(`<!--[--><div class="header-corner-fill" aria-hidden="true" data-v-c7833780></div><div class="header-corner-fill right" aria-hidden="true" data-v-c7833780></div><!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`</header>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["__scopeId", "data-v-c7833780"]]), { __name: "Header" });
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: containerRef,
        class: ["lottie-animation", __props.className],
        style: unref(containerStyle),
        "aria-hidden": __props.ariaHidden ? "true" : void 0,
        "aria-label": __props.ariaLabel || void 0,
        role: "img"
      }, _attrs))} data-v-8230f33a></div>`);
    };
  }
};
...
const __nuxt_component_0$2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-8230f33a"]]), { __name: "LottieAnimation" });
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LottieAnimation = __nuxt_component_0$2;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer orange white-text rounded-medium pad-50 grid grid-1 gap-65" }, _attrs))} data-v-9f6aa514><div data-v-9f6aa514>`);
      _push(ssrRenderComponent(_component_LottieAnimation, {
        path: "/lottie/roleplay.lottie",
        loop: "",
        "class-name": "footer-lottie",
        "aria-label": "Roleplay"
      }, null, _parent));
      _push(`</div><div class="show-sm" data-v-9f6aa514></div>`);
      if (visibleFooterColumns.value.length > 0) {
        _push(`<div class="flex footer-nav-container column row-md between-xs gap-50 gap-md-30 fluid-type bold line-height-1" style="${ssrRenderStyle({ "--desktop": "40", "--tablet": "26", "--mobile": "26" })}" data-v-9f6aa514><!--[-->`);
        ssrRenderList(visibleFooterColumns.value, (col) => {
          _push(`<div class="footer-column underline-links" data-v-9f6aa514>`);
      ...
      _push(`<div class="show-sm" data-v-9f6aa514></div><div class="show-md" data-v-9f6aa514></div><div class="flex between-xs bottom-xs reverse-md gap-60" data-v-9f6aa514>`);
      if (unref(footerCallToAction).length > 0) {
        _push(`<div class="fluid-type underline-links footer-cta" style="${ssrRenderStyle({ "--desktop": "40", "--mobile": "26" })}" data-v-9f6aa514>`);
        _push(ssrRenderComponent(__nuxt_component_0, { blocks: unref(footerCallToAction) }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="fluid-type" style="${ssrRenderStyle({ "--desktop": "40", "--mobile": "16" })}" data-v-9f6aa514>${ssrInterpolate(unref(copyright))}</div></div></footer>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-9f6aa514"]]), { __name: "Footer" });
...
export { _export_sfc as _, __nuxt_component_0$3 as a, __nuxt_component_3$1 as b, useSiteSettings as c, useNuxtApp as d, entry_default as default, useAsyncData as e, useRuntimeConfig as f, __nuxt_component_0 as g, useContactLink as h, injectPageLoading as i, useRoute as j, navigateTo as n, useHead as u };
